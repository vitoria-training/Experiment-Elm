module Page.Wireframe.LoginSignup.ResettingPasswordPage.ResettingPassword_06 exposing (..)
            ...
            [][
                el None
                    ...
                    column Main
                        ...
                        (List.concat
                            [ resettingPassword_06Layout model ]
                        )
            ]

resettingPassword_06Layout : Model -> List (Element Styles variation Msg)
resettingPassword_06Layout model =
    [ h1 Title
        [ paddingBottom ( model.height / 10 ) ](
            Element.text "パスワードの変更完了"
        )
    , textLayout None
