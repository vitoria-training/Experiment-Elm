module Page.Wireframe.UserPageAcount.UserAcount.Pass1 exposing (..)
...
setCurrentPassword : { a | currentPassword : b } -> b -> { a | currentPassword : b }
setCurrentPassword model ( s ) =
    { model | currentPassword = s }
setNewPassword : { a | newPassword : b } -> b -> { a | newPassword : b }
setNewPassword model ( s ) =
    { model | newPassword = s }
setConfirmNewPassword : { a | confirmNewPassword : b } -> b -> { a | confirmNewPassword : b }
setConfirmNewPassword model ( s ) =
    { model | confirmNewPassword = s }
...
update msg model =
    case msg of
        ...
        InputCurrentPassword s ->
            ( setCurrentPassword model ( s ), Cmd.none )
        
        InputNewPassword s ->
            ( setNewPassword model ( s ), Cmd.none )
        
        InputConfirmNewPassword s ->
            ( setConfirmNewPassword model ( s ), Cmd.none )
        ...
        , row TextBox
            ...
            row TextIDBox
                ...
                textLayout None
                    [ paddingTop 5
                    , paddingBottom 5 ][
                    Input.newPassword TextIDInputBox
                        [ paddingXY 3 3
                    ...
                    , Input.newPassword TextIDInputBox
                        [ paddingXY 3 3
                        , width ( px ( model.width / 3 ) ) ] {
                            onChange = InputConfirmNewPassword
