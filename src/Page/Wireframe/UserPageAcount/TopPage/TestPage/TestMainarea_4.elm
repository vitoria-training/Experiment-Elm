module Page.Wireframe.UserPageAcount.TopPage.TestPage.TestMainarea_4 exposing (..)
...
stylesheet model =
    Style.styleSheet
        ...
        , style Header
            [ Color.background TestColor.greenPt5
            , Border.all 1
            , Border.rounded 40
            ]
        , style Logo
        ...
        , style Text
            ...
            , Color.text TestColor.greenPt6
            , Border.all 1
            , Color.border Color255.black
            , Shadow.text
                { offset = ( 0, 0 )
                , blur = 5
                , color = Color255.black
                }
            ]
        , style Opacity
            [ Filter.opacity 50
        ...
        , style BKColor
            [ Color.background TestColor.clear
            ]
        ]
